...
export async function getAuthAndYear(request: NextRequest): Promise<{ errorResponse?: undefined, user: { username: string, token: string }, year: number } | { errorResponse: NextResponse, user?: undefined, year?: undefined }> {
