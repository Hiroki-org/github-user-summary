...
describe('apiUtils', () => {
  ...
  describe('handleErrorResponse', () => {
    it('should return 429 and Retry-After header for RateLimitError', () => {
      ...
      expect(result.init.headers["Retry-After"]).toBeDefined();
    });
    ...
    it('should fallback to 500 for invalid GitHubApiError status', () => {
      const error = new GitHubApiError('Bad status', 200);
