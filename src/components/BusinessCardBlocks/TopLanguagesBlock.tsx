...
export const TopLanguagesBlock = ({ topLanguages, topTopics, interests, activity, options }: Props) => {
  const { showTopics = false, showInterests = false, showActivityBreakdown = false } = options;
